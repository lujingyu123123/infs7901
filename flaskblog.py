...
#        query = 'insert into Post (Postid, Date_post, Title,Description,Location,Color,Car_type,Brand,Price,manu_year,Uid,Sid,Stars,Imageid) VALUES (' + "'" + str(postnum) + "',"  + "'" + timestamp + "'," + "'" + title + "',"+ "'" + content + "',"  + "'" + location + "'," + "'" + color + "',"+ "'" + carType + "',"  + "'" + brand + "'," + "'" + price + "'," + "'" + manuYear + "'," + "'" + str(user[0]) + "'," + "'" + str(specialist[0]) + "'," + "'" + str(stars) + "'," + "'" + str(image) + "'" ')' #Build the query
    if form.validate_on_submit():
        ...
        query = "insert into User (Uid,username,dob,Phone,email,password) VALUES(" + "'" + str(uid)+ "'," + "'" + username + "'," + "'" + dob + "'," + "'" + Phone + "'," + "'" + email + "'," + "'" + password +  "'" ')'
        print("query", query)
        c = conn.cursor()
        c.execute(query)
        ...
        # if  budget!=None:
        #     query = 'insert into Buyer(Uid,budget)'
        #     c.execute(query)
        # if  account!= None:
        #     query ='insert into Seller(Uid,acc_number)'
        #     c.execute(query)
